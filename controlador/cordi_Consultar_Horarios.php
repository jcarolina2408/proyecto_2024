...
<body>
    ...
    <div class="content">
    <center><h3>Consulta de Horarios</h3></center>
            ...
            foreach ($jornadas as $jornada) {
                ...
                if (empty($archivosJornada)) {
                    ...
                    foreach ($archivosJornada as $archivo) {
                        ...
                        $rutaArchivo = "../archivos_subidos/$carpeta/$subcarpetaBase/" . urlencode($archivo['nombre_seguro']);

                        echo "<div class='fileBox'>";
                        echo "<p>$nombreArchivo</p>";

                        // Enlace para descargar el archivo
                        echo "<a href='descargar_archivo.php?file=" . urlencode("$carpeta/$subcarpetaBase/" . $archivo['nombre_seguro']) . "' target='_blank'>Descargar</a>";

        ...
        if ($archivo['error'] === UPLOAD_ERR_OK) {
            ...
            if ($archivo['type'] === 'application/pdf') {
                ...
                if ($archivo['size'] > $maxFileSize) {
                    ...
                    $directorio = "../archivos_subidos/$carpeta/$subcarpeta/";
                    ...
                    if (move_uploaded_file($archivo['tmp_name'], $rutaArchivo)) {
                        try {
                            $insert = $conexion->prepare("INSERT INTO archivos (nombre_original, nombre_seguro, ruta_archivo, carpeta, subcarpeta, tipo) VALUES (?, ?, ?, ?, ?, 'horario')");

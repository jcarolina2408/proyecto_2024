...
<body>
    ...
    <div class="search-container">
            <form method="post" action="../controlador/admi_consultae_evidencias.php">
                <!-- Imagen centrada -->
                 <div class="divimg">
            ...
            <table class="table table-hover">
                ...
                foreach ($r as $valor) {
                    echo "<tr>
                        ...
                        <td>
                            <a href='controlador_evidencias_act1.php?txt1=$valor[nombre_taller]'>
                        ...
                        <td>
                            <a href='controlador_eliminar_evidencias.php?txt1=$valor[nombre_taller]'>
                                <button type='button' class='btn btn-outline-success'>

...
<body>
    ...
    <div class="container">
            ...
            <div class="big-box">
                <center><h2 class="h2">CONSULTAR EVIDENCIA POR NOMBRE DE TALLER</h2></center>
                <p>Esta consulta permite obtener detalles de las evidencias sobre los talleres dictados a los aprendices segun el nombre del taller.</p>
                <nav class="search-bar">
                    <form  method="GET" action="../controlador/prof_consultae_evidencias.php">  
                        <input  type="text" name="nombre" placeholder="Digite el nombre de la evidencia a consultar ">
    ...
    <div class="small-box-container">
                    <div class="small-box">
                        <form method="post" action="../controlador/prof_consultar_talleres.php">
                    ...
                    <div class="small-box">
                    <form method="post" action="../controlador/prof_consultar_horarios.php">

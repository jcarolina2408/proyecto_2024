...
<body>
    ...
    <div class="content">
    <center><h3>Cargar horarios</h3></center>
    <div class="folders" style="display: flex; flex-wrap: wrap;">
        ...
        <div class="folder" style="margin-right: 20px;">
            ...
            <div class="subfolder-content">
                <div class="subfolder">
                    ...
                    <form id="formCargaCalle52Diurna" action="cordi_procesar_carga.php" class="upload-form" method="post" enctype="multipart/form-data">
                ...
                <div class="subfolder">
                    <h5>Jornada Mixta</h5>
                    <form id="formCargaCalle52Mixta" action="cordi_procesar_carga.php" class="upload-form" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="carpeta" value="calle_52">
                ...
                <div class="subfolder">
                    ...
                    <form id="formCargaCalle52Nocturna" action="cordi_procesar_carga.php" class="upload-form" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="carpeta" value="calle_52">
        ...
        <div class="folder" style="margin-right: 20px;">
            ...
            <div class="subfolder-content">
                <div class="subfolder">
                    <h5>Jornada Diurna</h5>
                    <form id="formCargaFontibonDiurna" action="cordi_procesar_carga.php" class="upload-form" method="post" enctype="multipart/form-data">
                ...
                <div class="subfolder">
                    <h5>Jornada Mixta</h5>
                    <form id="formCargaFontibonMixta" action="cordi_procesar_carga.php" class="upload-form" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="carpeta" value="fontibon">
                        <input type="hidden" name="subcarpeta" value="jornada_mixta">
                        <input class="form-control" type="file" name="archivo" required>
                        <button type="submit" class="btn btn-primary btn-custom">Subir</button>
                ...
                <div class="subfolder">
                    <h5>Jornada Nocturna</h5>
                    <form id="formCargaFontibonNocturna" action="cordi_procesar_carga.php" class="upload-form" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="carpeta" value="fontibon">
                        <input type="hidden" name="subcarpeta" value="jornada_nocturna">
                        <input class="form-control" type="file" name="archivo" required>
                        <button type="submit" class="btn btn-primary btn-custom">Subir</button>
        ...
        <div class="folder">
            ...
            <div class="subfolder-content">
                <div class="subfolder">
                    <h5>Jornada Diurna</h5>
                    <form id="formCargaCalle64Diurna" action="cordi_procesar_carga.php" class="upload-form" method="post" enctype="multipart/form-data">
                ...
                <div class="subfolder">
                    <h5>Jornada Mixta</h5>
                    <form id="formCargaCalle64Mixta" action="cordi_procesar_carga.php" class="upload-form" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="carpeta" value="calle_64">
                        <input type="hidden" name="subcarpeta" value="jornada_mixta">
                        <input class="form-control" type="file" name="archivo" required>
                        <button type="submit" class="btn btn-primary btn-custom">Subir</button>
                ...
                <div class="subfolder">
                    <h5>Jornada Nocturna</h5>
                    <form id="formCargaCalle64Nocturna" action="cordi_procesar_carga.php" class="upload-form" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="carpeta" value="calle_64">
                        <input type="hidden" name="subcarpeta" value="jornada_nocturna">
                        <input class="form-control" type="file" name="archivo" required>
                        <button type="submit" class="btn btn-primary btn-custom">Subir</button>
    ...
    document.querySelectorAll('.upload-form').forEach(form => {
        form.onsubmit = function(event) {
            ...
            fetch('../controlador/cordi_procesar_carga.php', {
                method: 'POST',
                body: formData
            })
